...
const intern1 = { id: 0, name: "Mitzi", email: "mmelloy0@psu.edu" gender:"F" };

const intern2 = { id: 1, name: "Kennan", email: "kdiben1@tinypic.com", gender: "M", saysHello: function(){ console.log("Hello, my name is Kennan")} };

const intern3 = { id: 2, name: "Keven", email: "kmummery2@wikimedia.org", gender: "M" };
...
const parent = {
  ...
  "age": 70,
   saysName: function(){
     console.log(`${this.name} My name is ${name}`)
   }
   child: {
     "name": "George"
     "age": 50,
